...
public class QueryBaseLexer extends antlr.CharScanner implements TokenTypes, TokenStream
{

	// NOTE: The real implementations are in the subclass.
	protected void setPossibleID(boolean possibleID) {}
public QueryBaseLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public QueryBaseLexer(Reader in) {
	this(new CharBuffer(in));
}
public QueryBaseLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public QueryBaseLexer(LexerSharedInputState state) {
	super(state);
