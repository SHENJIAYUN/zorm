...
public class PersistentBag extends AbstractPersistentCollection implements List  {
	...
	public boolean equalsSnapshot(CollectionPersister persister) throws ZormException {
	...
	public Collection getOrphans(Serializable snapshot, String entityName) throws ZormException {
	...
	public Iterator getDeletes(CollectionPersister persister, boolean indexIsFormula) throws ZormException {
	...
	public boolean needsInserting(Object entry, int i, Type elemType) throws ZormException {
		//if ( !persister.isOneToMany() ) throw new AssertionFailure("Not implemented for Bags");
		List sn = (List) getSnapshot();
